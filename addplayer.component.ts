...
export class AddplayerComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder) {
    ...
    this.tennisId=new FormControl('',[Validators.required,
    Validators.min(1)]);
    this.tournamentId=new FormControl('',[Validators.required,
    ...
    this.matchNo=new FormControl('',[Validators.required,
      Validators.min(1)]);
    this.winnerName=new FormControl('',[Validators.required,
